--- layout
  : post title
  : moose type an coerce date
  : 2015 - 06 - 07 21
  : 04 categories
  : tech-- -

  firstly, what is ytype and coerce
  ?
...
### TYPE
  ...
  with a name
  and a constraint
  . Moose maintains a global type registry that lets it convert names like Num
  into the appropriate object
  .

  However, class names can be type names

### Subtype

  A subtype is defined in terms of a parent type
  and a constraint . Any constraints defined by the parent(
